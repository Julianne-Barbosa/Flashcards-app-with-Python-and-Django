...
def novo_flashcard(request):
    ...
    messages.add_message(request, constants.SUCCESS, 'Flashcard criado!')
    return redirect('/flashcard/novo_flashcard')
...
def listar_desafio(request):
    if request.method == "GET":
        ...
        if categoria_filtrar and dificuldade_filtrar:
        ...
        return render(request, 'listar_desafio.html', {'desafios': desafios, 'dificuldades': dificuldades, 'categorias': categorias,},)
